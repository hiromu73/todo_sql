...
class _$TodoData with DiagnosticableTreeMixin implements TodoData {
  ...
  factory _$TodoData.fromJson(Map<String, dynamic> json) =>
      _$_$TodoDataFromJson(json);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$_$TodoDataToJson(this);
  }
}
...
abstract class TodoData implements Todo {
  ...
  factory TodoData.fromJson(Map<String, dynamic> json) = _$TodoData.fromJson;
